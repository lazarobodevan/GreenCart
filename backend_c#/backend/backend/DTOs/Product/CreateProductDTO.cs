...
namespace backend.DTOs.Product {
    public class CreateProductDTO {
        ...
        public CreateProductDTO(string name, string? description, byte[]? picture, Category? category, double? price, Unit? unit, int? availableQuantity, bool? isOrganic, string? harvestDate, Guid? producerId) {
            Name = name;
