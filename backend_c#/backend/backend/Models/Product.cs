...
namespace backend.Models
{
    ...
    public class Product {
        ...
        public Product(Guid id, string name, string? description, byte[]? picture, Category category, double price, Unit unit, int availableQuantity, bool isOrganic, DateTime harvestDate, Guid producerId, DateTime? createdAt, DateTime? updatedAt, DateTime? deletedAt) {
            Id = id;
            Name = name;
